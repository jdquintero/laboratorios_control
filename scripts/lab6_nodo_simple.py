...
class Node():
	...
	self.topic_emergency = "/emergency"
        self.topic_ang = "/angular_g4"
        self.topic_lin = "/linear_g4"
	...
	self.paro = self.rospy.Subscriber(self.topic_emergency, String, 		self.callback_emergency)
        return
